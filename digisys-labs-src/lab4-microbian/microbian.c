...
The friendly interface, where message buffers can be omitted when not
needed, is also implemented here. */

#define SYSCALL      __attribute((naked))
