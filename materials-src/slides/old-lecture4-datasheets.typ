...
#title-slide(title: [Lecture 4 \ Datasheets & Programming])
...
#slide[
  ...
  #callout_important[Instruction behaviour result of hardware implementation][
    No way to know this, except to look it up!
  ] // Example of this was the quirks in assembly programming.
  - Already mentioned (lec 2) that machine code spec was in datasheet.
  - Now that we're programming, let's look the ways that we can find out the effect of instructions on our computer as a whole.
  #[All datasheets for the Microbit can be found at:
  - https://spivey.oriel.ox.ac.uk/digisys/The_BBC_micro:bit
  ]
  ]
]
...
#slide[
  ...
  image("figures/microbit-overview.png", width: 98%),
  image("figures/spivey-microbit-web-contents.png"))
  // From the outside in...
  // We have Accessories that we can connect ot the microbit
  // We have the microbit board itself. Someone designed this, and connected the Nordic chip to various things on the board. If you want to access the LEDs, you need to know which pin of the chip this is connected to.
  // Then we have the Nordic chip itself. It's particularly helpful if you want to use the on-chip peripherals. So, e.g. if you want to understand how characters are sent to the computer over UART, you will need to see the specification in this dataset.
...
#slide[
  ...
  #[Microbit elecrical schematic: https://spivey.oriel.ox.ac.uk/dswiki/images-digisys/5/5b/Microbit-schematic.pdf]
]
]
...
#slide[
  ...
  Reference manual: https://spivey.oriel.ox.ac.uk/dswiki/images-digisys/3/34/NRF51822-ref-manual.pdf
  - Similar process
  - Can find address of TxD register
